...
class AppForm extends StatefulWidget {
  ...
  AppForm({this.formKey, this.categoryNameController, this.categoryDescriptionController, this.categoryUrlController});
    ...
    return Form(
      ...
      child: Column(
        children: <Widget>[
          ...
          TextFormField(
            controller: widget.categoryDescriptionController,
            keyboardType: TextInputType.text,
            decoration: InputDecoration(labelText: 'Kategori Açıklaması'),
            validator: _validateName,
          ),
          TextFormField(
            controller: widget.categoryUrlController,
            keyboardType: TextInputType.text,
            decoration: InputDecoration(labelText: 'Kategori Url'),
            validator: _validateName,
          ),
         /* TextFormField(
