...
class _DetailsState extends State<Details> {
  void deleteKategori(context) async {
    await http.post(Uri.parse("${SiteLink.URL_PREFIX}/category_delete.php"),
      body: {
    ...
    return Scaffold(
              ...
              new Container(
                ...
                decoration: new BoxDecoration(
                  ...
                  image: new DecorationImage(
                    image: new NetworkImage('${SiteImageLink.URL_PREFIX}/${widget.kategori.img}'),
                    fit: BoxFit.cover,
                  ),
      ...
      floatingActionButton: FloatingActionButton(
       ...
       /* onPressed: () => Navigator.of(context).push(
          MaterialPageRoute(
            builder: (BuildContext context) => Edit(kategori: widget.kategori),
          ),
        ),*/
      ),
    );
